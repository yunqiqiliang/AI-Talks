...
def init_gpt_conversation() -> None:
    try:
        st.session_state.messages.append({"role": "code assistant", "content": prompts_schema})
        st.session_state.messages.append({"role": "code assistant", "content": prompts_ord})
        st.session_state.messages.append({"role": "code assistant", "content": prompts_sql_standard})
